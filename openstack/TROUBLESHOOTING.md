...
for node in $NODES; do
  ...
  ssh ubuntu@$node "sudo crictl pull nrel/openstudio-server:3.8.0-1"
  ssh ubuntu@$node "sudo crictl pull mongo:6.0.7"
  ssh ubuntu@$node "sudo crictl pull redis:6.0.9"
done
```
